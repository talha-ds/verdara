...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8faf8] via-white to-[#f0f7f0] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1a1a1a] mt-6 mb-2">Welcome Back</h1>
        ...
        <p className="text-center text-xs text-[#6b7280] mt-6">
          🌿 100% Natural Products • Trusted by thousands
        </p>
      </div>
    </div>
  )
